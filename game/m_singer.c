...
void SP_monster_singer_x(edict_t* self)
{
	...
	self->s.modelindex = gi.modelindex("models/monsters/solider/tris.md2");
	...
	sound_idle = gi.soundindex("solider/solidle1.wav");
	sound_sight1 = gi.soundindex("solider/solsght1.wav");
	sound_sight2 = gi.soundindex("solider/solsrch1.wav");
...
void SP_monster_singer_light(edict_t* self)
{
	...
	sound_pain_light = gi.soundindex("solider/solpain2.wav");
	sound_death_light = gi.soundindex("solider/soldeth2.wav");
	gi.modelindex("models/objects/laser/tris.md2");
	gi.soundindex("misc/lasfly.wav");
	gi.soundindex("solider/solatck2.wav");
...
void SP_monster_singer(edict_t* self)
{
	...
	sound_pain = gi.soundindex("solider/solpain1.wav");
	sound_death = gi.soundindex("solider/soldeth1.wav");
	gi.soundindex("solider/solatck1.wav");
...
void SP_monster_singer_ss(edict_t* self)
{
	...
	sound_pain_ss = gi.soundindex("solider/solpain3.wav");
	sound_death_ss = gi.soundindex("solider/soldeth3.wav");
	gi.soundindex("solider/solatck3.wav");
